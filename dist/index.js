...
;// CONCATENATED MODULE: ./node_modules/github-project/api/lib/get-fields-update-query-and-fields.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/lib/update-project-item-fields.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.add.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.get-by-content-id.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.get-by-content-repository-and-number.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.update.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.update-by-content-id.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.update-by-content-repository-and-number.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/lib/archive-project-item.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.archive.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.archive-by-content-id.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.archive-by-content-repository-and-number.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/lib/remove-project-item.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.remove.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.remove-by-content-id.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/items.remove-by-content-repository-and-name.js
// @ts-check
...
;// CONCATENATED MODULE: ./node_modules/github-project/api/lib/default-truncate-function.js
/**
 ...
 * @returns {string}
 */
function defaultTruncateFunction(text) {
  return text;
}

;// CONCATENATED MODULE: ./node_modules/github-project/api/errors.js
// @ts-check

class GitHubProjectError extends Error {
  constructor(message) {
    super(message);
...
class GitHubProjectNotFoundError extends GitHubProjectError {
  constructor(details) {
...
class GitHubProjectUnknownFieldError extends GitHubProjectError {
  constructor(details) {
...
class GitHubProjectInvalidValueError extends GitHubProjectError {
  constructor(details) {
...
class GitHubProjectUnknownFieldOptionError extends GitHubProjectInvalidValueError {
  constructor(details) {
    super(details);
...
class GitHubProjectUpdateReadOnlyFieldError extends GitHubProjectError {
  constructor(details) {
